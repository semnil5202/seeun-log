...
const UI_STRINGS: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'profile.bio': '거친 세상 속, 은민커플이 직접 경험하고 기록하는 생존기',
  ...
  en: {
    ...
    'profile.bio': 'A survival guide experienced and recorded by the Eunmin couple in a tough world.',
  ...
  ja: {
    ...
    'profile.bio': '厳しい世の中で、ウンミンカップルが直接体験して記録するサバイバル記',
  ...
  'zh-CN': {
    ...
    'profile.bio': '艰难世界中，银民情侣亲身体验并记录的生存记',
  ...
  'zh-TW': {
    ...
    'profile.bio': '艱難世界中，銀民情侶親身體驗並記錄的生存記',
  ...
  id: {
    ...
    'profile.bio': 'Catatan bertahan hidup di dunia yang keras, dialami dan dicatat langsung oleh pasangan Eunmin.',
  ...
  vi: {
    ...
    'profile.bio': 'Nhật ký sinh tồn trong thế giới khắc nghiệt, được cặp đôi Eunmin trực tiếp trải nghiệm và ghi lại.',
  ...
  th: {
    ...
    'profile.bio': 'บันทึกการเอาตัวรอดในโลกอันโหดร้าย ที่คู่รักอึนมินสัมผัสและบันทึกด้วยตัวเอง',
