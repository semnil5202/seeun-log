...
const UI_STRINGS: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'profile.bio': '거친 세상 속, 은민커플이 직접 경험하고 기록하는 이야기',
  ...
  en: {
    ...
    'profile.bio': 'Stories personally experienced and recorded by the Eunmin couple.',
  ...
  ja: {
    ...
    'profile.bio': 'ウンミンカップルが直接体験して記録する物語',
  ...
  id: {
    ...
    'profile.bio': 'Kisah yang dialami dan dicatat langsung oleh pasangan Eunmin.',
  ...
  vi: {
    ...
    'profile.bio': 'Những câu chuyện được cặp đôi Eunmin trực tiếp trải nghiệm và ghi lại.',
  ...
  th: {
    ...
    'profile.bio': 'เรื่องราวที่คู่รักอึนมินสัมผัสและบันทึกด้วยตัวเอง',
