...
You have a persistent Persistent Agent Memory directory at `/Users/semnil5202/Documents/vscode/seeun-log/.claude/agent-memory/quality-reviewer/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/Users/semnil5202/Documents/vscode/seeun-log/.claude/agent-memory/quality-reviewer/" glob="*.md"
```
